  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 64px - var(--safe-area-top))', padding: '88px 32px 80px' }}>
      <div style={{ maxWidth: '768px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '48px' }}>
          <div
            ...
            style={{
              ...
              justifyContent: 'center', fontSize: '18px', fontWeight: 700, flexShrink: 0,
            }}
          >
            MR
          </div>
          <div>
            <h1
              className="font-serif"
              style={{ fontWeight: 700, fontSize: 'clamp(22px, 4vw, 28px)', margin: '0 0 4px', lineHeight: 1.1, color: 'var(--text-primary)' }}
            >
            ...
            <p
              style={{
                ...
                letterSpacing: '0.12em', margin: 0, color: 'var(--text-muted)',
              }}
            >
        ...
        {/* §01 — Profile */}
        <div style={{ paddingBottom: '40px', borderBottom: '1px solid var(--separator)' }}>
          <p
            style={{
              fontFamily: "'IBM Plex Mono', monospace",
              fontSize: '11px', textTransform: 'uppercase',
              letterSpacing: '0.16em', margin: '0 0 20px', color: 'var(--text-muted)',
            }}
          >
            § 01 — Profile
          </p>
          <p
            ...
            style={{
              ...
              lineHeight: 1.4, margin: '0 0 20px', color: 'var(--text-primary)',
            }}
          >
          ...
          <p
            style={{
              fontSize: '16px', lineHeight: 1.7, margin: 0,
        ...
        <div style={{ padding: '40px 0', borderBottom: '1px solid var(--separator)' }}>
          <p
            style={{
              fontFamily: "'IBM Plex Mono', monospace",
              fontSize: '11px', textTransform: 'uppercase',
            ...
            {PRINCIPLES.map((p) => (
              ...
              >
                ...
                <div>
                  <p
                    className="font-serif"
                    style={{ fontSize: '18px', fontWeight: 600, margin: '0 0 6px', lineHeight: 1.3, color: 'var(--text-primary)' }}
                  >
                    {p.title}
                  </p>
                  <p
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            <a
              ...
              style={{
                ...
                textDecoration: 'none', borderRadius: '2px', minHeight: '36px',
