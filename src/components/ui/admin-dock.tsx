    ...
    <>
      ...
      <div>
        ...
        <motion.div
          ...
          className="fixed left-0 top-0 h-full w-56 sm:w-60 md:w-60 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-lg z-40"
        >
            ...
            <div className="space-y-1 sm:space-y-2">
              {items.map((item, index) => (
                <motion.button
                  ...
                  className={`w-full flex items-center space-x-3 px-3 sm:px-4 py-3 sm:py-4 md:py-3 rounded-lg transition-colors duration-200 text-left ${
