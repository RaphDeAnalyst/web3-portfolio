        ...
        {image ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 via-gray-50 to-gray-200 dark:from-gray-800 dark:via-gray-850 dark:to-gray-900 relative overflow-hidden">
            ...
            <div className="relative text-center space-y-4 z-10">
              <div className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-r from-${categoryColors[category as keyof typeof categoryColors] || 'cyber-500'} to-${categoryColors[category as keyof typeof categoryColors] || 'cyber-500'}/70 flex items-center justify-center text-white text-3xl shadow-lg shadow-${categoryColors[category as keyof typeof categoryColors] || 'cyber-500'}/25 group-hover:scale-110 transition-transform duration-300`}>
                {category === 'Analytics' && '📊'}
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium text-foreground/80">Dashboard Preview</div>
