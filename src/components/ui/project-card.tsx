        ...
        <div className="mt-auto space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {demoUrl && demoUrl !== '#' && demoUrl.trim() !== '' ? (
              <Link href={demoUrl} target="_blank" className="flex-1 min-w-0">
                <button className={`w-full px-4 py-3 rounded-lg bg-gradient-to-r from-${categoryColors[category as keyof typeof categoryColors] || 'cyber-500'} to-${categoryColors[category as keyof typeof categoryColors] || 'cyber-500'}/70 text-gray-900 dark:text-white font-medium hover:scale-105 transition-transform duration-200 shadow-lg`}>
                  Read More
                </button>
              </Link>
            ) : (
              <button 
                disabled 
                className="flex-1 min-w-0 px-4 py-3 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-500 dark:text-gray-400 font-medium cursor-not-allowed opacity-60"
            ...
            {githubUrl && githubUrl !== '#' && githubUrl.trim() !== '' ? (
              <Link href={githubUrl} target="_blank">
                <button className="px-4 py-3 rounded-lg border border-border text-foreground hover:border-cyber-500 hover:text-cyber-500 transition-colors duration-200">
              ...
              <button 
                disabled 
                className="px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed opacity-60"
            ...
            {/* Additional dynamic buttons */}
            {duneUrl && duneUrl !== '#' && duneUrl.trim() !== '' && (
              <Link href={duneUrl} target="_blank">
                <button className="px-4 py-3 rounded-lg border border-border text-foreground hover:border-primary-500 hover:text-primary-500 transition-colors duration-200 text-sm font-medium">
                  Dune Dashboard
                </button>
              </Link>
            )}
            {blogPostSlug && blogPostSlug.trim() !== '' && (
              <Link href={`/blog/${blogPostSlug}`}>
                <button className="px-4 py-3 rounded-lg border border-border text-foreground hover:border-purple-500 hover:text-purple-500 transition-colors duration-200 text-sm font-medium">
                  Read Blog Post
                </button>
              </Link>
            )}
